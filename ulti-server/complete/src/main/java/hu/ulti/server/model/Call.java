...
public class Call {
	...
	public static List<Call> getAllCalls() {
		...
		calls.add(new Call(0, PASSZ_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(1, CSENDES_SZAZ_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(2, CSENDES_ULTI_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(3, SZAZ40_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(4, ULTI_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(5, BETLI_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(6, DURI_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(7, DURI_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(8, SZAZ20_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(9, BETLI_TERITETT_VALUE * MAKK_COLOR_ID));
		calls.add(new Call(10, DURI_TERITETT_VALUE * MAKK_COLOR_ID));
		...
		calls.add(new Call(18, DURI_VALUE * ZOLD_COLOR_ID));
		calls.add(new Call(19, DURI_VALUE * ZOLD_COLOR_ID));
		calls.add(new Call(20, SZAZ20_VALUE * ZOLD_COLOR_ID));
		calls.add(new Call(21, BETLI_TERITETT_VALUE * ZOLD_COLOR_ID));
